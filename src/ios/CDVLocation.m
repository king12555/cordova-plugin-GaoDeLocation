...
- (void)returnLocationInfo:(NSString*)callbackId andKeepCallback:(BOOL)keepCallback
{
    ...
    if (lData && !lData.locationInfo) {
        ...
        //转化到高德经纬度
        CLLocationCoordinate2D amapcoord = AMapCoordinateConvert([lInfo coordinate], AMapCoordinateTypeGPS);
        ...
        [returnInfo setObject:[NSNumber numberWithDouble:amapcoord.latitude] forKey:@"latitude"];
        [returnInfo setObject:[NSNumber numberWithDouble:amapcoord.longitude] forKey:@"longitude"];
